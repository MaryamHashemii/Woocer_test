...
import com.woocer.test.presentation.BaseImageView;
...
public abstract class ItemProductBinding extends ViewDataBinding {
  ...
  @NonNull
  public final AppCompatRatingBar ratingBarRate;
  ...
  protected ItemProductBinding(Object _bindingComponent, View _root, int _localFieldCount,
      BaseImageView ivPic, AppCompatRatingBar ratingBarRate, TextView tvPrice, TextView tvRate,
      TextView tvRateCount, TextView tvTitle) {
    super(_bindingComponent, _root, _localFieldCount);
    this.ivPic = ivPic;
    this.ratingBarRate = ratingBarRate;
