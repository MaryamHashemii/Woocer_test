...
public abstract class Hilt_FragmentBasket<T extends ViewDataBinding> extends BaseDataBindingFragment<T> implements GeneratedComponentManagerHolder {
  ...
  Hilt_FragmentBasket(int layoutRes) {
    super(layoutRes);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentBasket_GeneratedInjector) this.generatedComponent()).injectFragmentBasket(UnsafeCasts.<FragmentBasket>unsafeCast(this));
    }
  }
