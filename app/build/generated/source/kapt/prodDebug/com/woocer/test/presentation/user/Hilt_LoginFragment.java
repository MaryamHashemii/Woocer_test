...
public abstract class Hilt_LoginFragment<T extends ViewDataBinding> extends BaseDataBindingFragment<T> implements GeneratedComponentManagerHolder {
  ...
  Hilt_LoginFragment(int layoutRes) {
    super(layoutRes);
  }
