...
public abstract class Hilt_ProductFragment<T extends ViewDataBinding> extends ObserverDataBindingFragment<T> implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProductFragment(int layoutRes) {
    super(layoutRes);
  }
